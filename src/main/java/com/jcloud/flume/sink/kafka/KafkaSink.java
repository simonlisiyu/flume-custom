...
package com.jcloud.flume.sink.kafka;
...
import static com.jcloud.flume.sink.kafka.KafkaSinkConstants.*;
...
//      System.arraycopy(bytesHeader, 0, returnBytes, bytes.length, bytesHeader.length);
      // lisiyu add bytesHeader to returnBytes, End...
    }
    return bytes;
  }
